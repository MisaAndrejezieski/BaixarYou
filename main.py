...
class VideoDownloader(ctk.CTk):
    def __init__(self):
        ...
        self.last_file = None  # guarda o último vídeo baixado
    ...
    def create_widgets(self):
        ...
        # Botão para exibir vídeo (inicialmente desativado)
    ...
    def download_sucesso(self) -> None:
        ...
        self.exibir_btn.configure(state="normal")  # habilita botão de exibir
        self.reset_ui()
